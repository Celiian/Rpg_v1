...
|       |                                                           /
|       |----------------------------------------------------------'
\       |   The Paladin is very is the very versatile and have a good 
 \     /    amount of hp and mana. His classes Skills are very useful
  `---'     and can heal or buff him easily, making him very good for 
            long fight.                                                      """)


def assassin_description():
    assassin()
    time.sleep(2)
    print("""                                    
                                                                .---.
...
|       |          / /\ \ / __/ __|/ _` / __/ __| | '_ \             |
|       |         / ____ \\__ \__ \ (_| \__ \__ \ | | | |            |
|       |        /_/    \_\___/___/\__,_|___/___/_|_| |_|            |
|       |                                                            |*
|       |                                                           /
|       |----------------------------------------------------------'
\       |   The Assassin is a very strong damage dealer and have a 
 \     /    good speed. He can dodge and inflict critical damage, 
  `---'     the Assassin depend on his luck but can kill his 
            enemies within a very short time. His class Skills can
            apply some effects to the enemies to poison him or 
            augment the damage done by the assassin.                      """)
...
|       |                      |___/                                /
|       |----------------------------------------------------------'
\       |   The Mage have a very good mana reserve, he can display 
 \     /    many powerful skills but is quite weak with basic attack.
  `---'     His class Skills help him to overcome his low strength
            with good buff and can easily restore his mana.         """)
